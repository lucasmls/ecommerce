...
var (
	productAllColumns            = []string{"id", "name", "description", "price", "created_at", "updated_at"}
	productColumnsWithoutDefault = []string{"name", "description", "price", "created_at", "updated_at"}
